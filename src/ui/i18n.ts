  ...
  en: {
    translation: {
      ...
      chart: {
        ...
        mapNoRegion: 'Please select a region map',
        mapNoRegionColumns: 'Please select region and metric columns',
        mapUnknownRegion: 'That region map is not available',
        mapNoLatLng: 'Please select longitude and latitude columns',
        mapUnsupportedType: 'This map type is not supported',
        mapNoData: 'No data',
        mapFilteredRows_one: 'Filtered out {{count}} row with missing coordinates',
        mapFilteredRows_other: 'Filtered out {{count}} rows with missing coordinates',
      },
      errors: {
  ...
  zh: {
    translation: {
      ...
      chart: {
        ...
        pivotGrandTotal: '总计',
        mapNoRegion: '请选择区域地图',
        mapNoRegionColumns: '请选择区域和指标列',
        mapUnknownRegion: '该区域地图不可用',
        mapNoLatLng: '请选择经度和纬度列',
        mapUnsupportedType: '不支持该地图类型',
        mapNoData: '暂无数据',
        mapFilteredRows_one: '已过滤 {{count}} 行缺失坐标的数据',
        mapFilteredRows_other: '已过滤 {{count}} 行缺失坐标的数据',
      },
      errors: {
        invalidUrl: '该地址格式不正确。',
